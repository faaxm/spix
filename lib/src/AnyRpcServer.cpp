...
: m_pimpl(new AnyRpcServerPimpl())
{
    ...
    utils::AddFunctionToAnyRpc<void(std::string, double, double)>(methodManager, "mouseClickWithOffset",
        "Click on the object at the given path with the given offset (absolute pixel) | mouseClickWithOffset(string path, float "
    ...
    utils::AddFunctionToAnyRpc<void(std::string, double, double)>(methodManager, "mouseClickWithProportion",
        "Click on the object at the given path with the given proportion (In percent) | mouseClickWithProportion(string path, float "
