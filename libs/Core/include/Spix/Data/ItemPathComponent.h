 ...
 */
class SPIXCORE_EXPORT NameSelector {
public:
 ...
 */
class SPIXCORE_EXPORT PropertySelector {
public:
 ...
 */
class SPIXCORE_EXPORT TypeSelector {
public:
 ...
 */
class SPIXCORE_EXPORT ValueSelector {
public:
 ...
 */
class SPIXCORE_EXPORT PropertyValueSelector {
public:
 ...
 */
class SPIXCORE_EXPORT Component {
public:
    Component() = default;
